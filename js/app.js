...
Vue.component('dashboard',{
    template : '<div> <nav-bar></nav-bar> <br> <div class="row container"> <div class="col-4 container">  <h6><tools-icon></tools-icon> Quick tools</h6> <tools></tools></div> <div class="col-8 container"><h6> <dash-icon></dash-icon> dashboard</h6>  <router-view class="dash container"></router-view></div> </div>'
})
